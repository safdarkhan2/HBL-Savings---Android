...
import com.hbl.amc.ui.ML_Kit.camera.GraphicOverlay
import com.hbl.amc.ui.ML_Kit.camera.WorkflowModel
import com.hbl.amc.ui.ML_Kit.camera.WorkflowModel.WorkflowState
import com.hbl.amc.ui.ML_Kit.camera.CameraSource
import com.hbl.amc.ui.ML_Kit.camera.CameraSourcePreview
import com.hbl.amc.ui.ML_Kit.objectdetection.MultiObjectProcessor
import com.hbl.amc.ui.ML_Kit.objectdetection.ProminentObjectProcessor
import com.hbl.amc.ui.ML_Kit.productsearch.BottomSheetScrimView
import com.hbl.amc.ui.ML_Kit.productsearch.ProductAdapter
import com.hbl.amc.ui.ML_Kit.productsearch.SearchEngine
import com.hbl.amc.ui.ML_Kit.settings.PreferenceUtils
import com.hbl.amc.ui.ML_Kit.settings.SettingsActivity
import com.hbl.amc.R
import com.hbl.amc.ui.ML_Kit.objectdetection.DetectedObject
...
class LiveObjectDetectionActivity : AppCompatActivity(), OnClickListener {
    ...
    var detectedIdCard : DetectedObject? = null
...
//                Toast.makeText(this@LiveObjectDetectionActivity, "work flow state : " + workflowState.name, Toast.LENGTH_LONG).show()
            })
            ...
            objectToSearch.observe(this@LiveObjectDetectionActivity, Observer { detectObject ->
                ...
                detectedIdCard = detectObject

                try {
//                    if (currentWorkflowState!!.name.equals("searched", true)) {
//                    Toast.makeText(this@LiveObjectDetectionActivity, "search engine : " + detectObject.toString(), Toast.LENGTH_LONG).show()
                        detectedIdCard?.let {
                            val resultIntent = Intent()
                            resultIntent.putExtra(SCANNED_IMAGE, it.imageData)
...
//
//                Toast.makeText(this@LiveObjectDetectionActivity, "searched object : " + searchedObject.productList[0].imageUrl, Toast.LENGTH_LONG).show()
