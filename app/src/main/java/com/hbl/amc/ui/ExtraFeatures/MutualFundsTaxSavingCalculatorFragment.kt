...
import com.hbl.amc.databinding.FragmentMutualFundsTaxSavingsCalculatorBinding
import com.hbl.amc.utils.setupEditText

class MutualFundsTaxSavingCalculatorFragment : Fragment() {

    private var _binding: FragmentMutualFundsTaxSavingsCalculatorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding =
            FragmentMutualFundsTaxSavingsCalculatorBinding.inflate(inflater, container, false)
